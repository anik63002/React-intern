      ...
      <div className=" max-h-[800px] max-w-[360px]  bg-white rounded-3xl overflow-hidden ">
        ...
        <div className=" max-h-[100px] max-w-[360px] bg-white flex-col mt-12  ml-5">
          <div className=" h-[80px] w-[250px] chatFirst rounded-xl ">
            <div className="h-[60px] w-[220px] ">
              <p className=" text-sm">
                Hi Sam! I am your personal shopping assistant, how can i <br />{" "}
                help you today ?
              </p>
            </div>
          </div>
        ...
        <div className="messageBar flex flex-row-reverse mt-8 max-h-[40px]">
          <div className="h-[40px] w-[70px] search_Arrow pt-3 pl-5">
            <img src={chevron_white} alt=" cheveon white" className=" h-[17px] w-[9px] ml-3" />
          </div>
          <div className=" h-[40px] w-[265px] flex items-center">
            <input type="text  "  placeholder="Type your message" className=" h-[22px]  rounded-xl  text-sm mt-2 pl-8 pr-14 py-4 ml-[-8px]"/>
             <img src={paperClip} alt=" vector" className=" h-5 w-5 paperClip" />
          </div>
        </div>
        <div className="messageBar flex items-center justify-center pb-3 pt-2">
          <p className=" font-normal text-sm alpha"> Powered by<span className=" font-semibold text-sm Krunk"> Krunk.ai</span></p>
